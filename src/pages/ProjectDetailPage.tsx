    ...
    <div className="p-8 flex-1 min-w-0">
      ...
      {!editing ? (
        <div className="flex flex-col gap-5">
          ...
          <div className="bg-white dark:bg-[#141418] rounded-card shadow-card border border-black/[0.08] dark:border-white/[0.08] p-5">
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-5">
          ...
          <div className="bg-white dark:bg-[#141418] rounded-card shadow-card border border-black/[0.08] dark:border-white/[0.08] p-5 flex flex-col gap-4">
            <div>
              <label
                htmlFor="edit-name"
